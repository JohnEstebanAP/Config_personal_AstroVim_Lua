...
_G.packer_plugins = {
  ...
  ["dressing.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/john/.local/share/nvim/site/pack/packer/opt/dressing.nvim",
  ...
  ["symbols-outline.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/john/.local/share/nvim/site/pack/packer/opt/symbols-outline.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lsp-installer', 'nvim-colorizer.lua', 'null-ls.nvim', 'FixCursorHold.nvim', 'Comment.nvim', 'neoscroll.nvim', 'nvim-treesitter', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-lsp-installer', 'nvim-colorizer.lua', 'null-ls.nvim', 'FixCursorHold.nvim', 'Comment.nvim', 'neoscroll.nvim', 'nvim-treesitter', 'gitsigns.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'dressing.nvim', 'nvim-cmp'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
