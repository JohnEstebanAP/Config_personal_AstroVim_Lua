...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-treesitter', 'nvim-lsp-installer', 'FixCursorHold.nvim', 'Comment.nvim', 'neoscroll.nvim', 'nvim-colorizer.lua', 'null-ls.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-treesitter', 'nvim-lsp-installer', 'FixCursorHold.nvim', 'Comment.nvim', 'neoscroll.nvim', 'nvim-colorizer.lua', 'null-ls.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'nvim-cmp', 'dressing.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
